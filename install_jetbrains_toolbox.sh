...
git clone git@github.com/stefanpl/phpstorm-config ${HOME}/.phpstorm-config

logSuccess "Jetbrains Toolbox installed. \Install PHPStorm via the toolbox, \
then import settings from ~/.phpstorm-config"
jetbrains-toolbox